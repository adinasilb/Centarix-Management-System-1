...
namespace PrototypeWithAuth.Data.Migrations
{
    ...
    [Migration("20210513064238_PermanentIDNullable")]
    partial class PermanentIDNullable
    {
            ...
            modelBuilder.Entity("PrototypeWithAuth.Models.TempLine", b =>
                {
                    ...
                    b.Property<int?>("PermanentLineIDs")
                        .IsRequired()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrototypeWithAuth.Models.TempLine", b =>
                {
                    ...
                    b.HasOne("PrototypeWithAuth.Models.TempLine", "ParentLine")
                        .WithMany()
                        .HasForeignKey("ParentLineID")
                        .HasPrincipalKey("PermanentLineIDs")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PrototypeWithAuth.Models.Line", "PermanentLine")
                        .WithOne()
                        .HasForeignKey("PrototypeWithAuth.Models.TempLine", "PermanentLineIDs")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
