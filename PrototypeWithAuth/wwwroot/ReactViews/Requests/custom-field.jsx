...
export default class CustomField extends Component {
    ...
    render() {
        ...
        //console.log(this.props.ValidationErrors[0][this.props.number]);
        //console.log("DATA TYPE validation errors");
        //console.log(this.props.ValidationErrors[0][this.props.number].dataType);
