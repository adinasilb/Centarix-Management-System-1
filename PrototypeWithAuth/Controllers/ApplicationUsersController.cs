            ...
            foreach (Employee employee in employees)
            {
                ...
                switch (yearlyMonthlyEnum)
                {
                    case YearlyMonthlyEnum.Monthly:
                        ...
                        daysLeftOfMonthOrYear = (int)GetTotalWorkingDaysByInterval(DateTime.Now.Date, new DateTime(year, month + 1, 1), companyDaysOff);
                    ...
                    case YearlyMonthlyEnum.Yearly:
                        ...
                        daysLeftOfMonthOrYear = (int)GetTotalWorkingDaysByInterval(DateTime.Now.Date,  new DateTime(year + 1, 1, 1), companyDaysOff);
