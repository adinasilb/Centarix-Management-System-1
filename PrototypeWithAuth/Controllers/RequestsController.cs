...
//                            wheres.Add(r => r.OrderType == AppUtility.OrderMethod.RequestPriceQuote.ToString());
...
//                             (AppUtility.IndexTableTypes.LabOrders, r, r.ApplicationUserCreator, r.Product, r.Product.Vendor, r.Product.ProductSubcategory,
...
//                            iconList.Add(deleteIcon);
//                            orderby = r => r.CreationDate;
//                            select = r => new RequestIndexPartialRowViewModel(AppUtility.IndexTableTypes.LabQuotes, r, r.ApplicationUserCreator, r.Product, r.Product.Vendor, r.Product.ProductSubcategory,
...
//                    wheres.Add(r => r.RequestStatusID == 6 && r.OrderType == AppUtility.OrderMethod.AddToCart.ToString());
//                    wheres.Add(r => r.Product.ProductSubcategory.ParentCategory.CategoryTypeID == 1);
//                    includes.Add(new ComplexIncludes<Request, ModelBase> { Include = r => r.ApplicationUserCreator });
//                    iconList.Add(deleteIcon);
//                    orderby = r => r.CreationDate;
...
//            }
//            request.OrderType = AppUtility.OrderMethod.AddToCart.ToString();
...
//            request.OrderType = AppUtility.OrderMethod.AlreadyPurchased.ToString();
...
//            /*try
//            {*/
//            request.OrderType = AppUtility.OrderMethod.OrderNow.ToString();
//            if (isInBudget)
//            {
//                request.RequestStatusID = 6;
//            }
...
//                    newRequest.OrderType = AppUtility.OrderMethod.RequestPriceQuote.ToString();
...
//                    newRequest.OrderType = AppUtility.OrderMethod.Save.ToString();
//                    newRequest.Unit = 1;
...
//                    {
//                        wheres.Add(r => r.Product.VendorID == vendorID && r.RequestStatusID == 6 && r.OrderType == AppUtility.OrderMethod.AddToCart.ToString()
//                            && r.QuoteStatusID == 4);
//                        wheres.Add(r => r.ApplicationUserCreatorID == _userManager.GetUserId(User));
...
//                    {
//                        wheres.Add(r => r.Product.VendorID == vendorID && r.RequestStatusID == 6 && r.OrderType == AppUtility.OrderMethod.RequestPriceQuote.ToString()
//                         && r.QuoteStatusID == 4);
//                    }
//                    tempRequestListViewModel.TempRequestViewModels = new List<TempRequestViewModel>();
//                }
...
//                            if (tempRequest.Request.OrderType == AppUtility.OrderMethod.AlreadyPurchased.ToString() ||  needsToBeApproved)
//                            {
...
//                                if (tempRequest.Request.OrderType == AppUtility.OrderMethod.OrderNow.ToString())
//                                {
...
//                        if (deserializedTempRequestListViewModel.TempRequestViewModels[0].Request.OrderType == AppUtility.OrderMethod.OrderNow.ToString())
//                        {
...
//            try
//            {
//                switch (Enum.Parse(typeof(AppUtility.OrderMethod), request.OrderType))
//                {
//                    case AppUtility.OrderMethod.OrderNow:
//                        TempRequestListViewModel trlvm = new TempRequestListViewModel()
//                        {
...
//                using (var transaction = _applicationDbContextTransaction.Transaction)
//                {
//                    var requests = _requestsProc.Read(new List<Expression<Func<Request, bool>>> { r => r.OrderType == AppUtility.OrderMethod.RequestPriceQuote.ToString() },
//                        new List<ComplexIncludes<Request, ModelBase>>
//                        {
...
//            Wheres.Add(r => r.Payments.FirstOrDefault().HasInvoice == false && ((r.PaymentStatusID == 2/*+30*/ && r.RequestStatusID == 3) || (r.PaymentStatusID == 3/*pay now*/) || (r.PaymentStatusID == 8/*specify payment*/ && r.RequestStatusID == 3)));
//            Wheres.Add(r => r.RequestStatusID != 7);
//            if (vendorid != null)
//            {
//                Wheres.Add(r => r.Product.VendorID == vendorid);
...
//                if (deserializedTempRequestListViewModel.TempRequestViewModels.FirstOrDefault().Request.OrderType != AppUtility.OrderMethod.AddToCart.ToString())
//                {
//                    tempRequestListViewModel.RequestIndexObject.GUID = tempRequestListViewModel.GUID;
...
//            r.OrderType == AppUtility.OrderMethod.AddToCart.ToString() && r.RequestStatusID != 1 })
//                .Select(r => r.Cost).Sum();
